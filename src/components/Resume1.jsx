...
const Resume1 = ({ resume, updateResumeData }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-4">
      ...
      <div className="w-full md:w-[768px] lg:w-[1010px] px-2 lg:px-24 2xl:px-14">
        <div className="flex flex-wrap justify-start lg:justify-end gap-4 mb-4">
          <button
        ...
        <div
          className="w-full grid grid-cols-12 px-1 sm:px-2 md:px-4 py-2 sm:py-4 md:py-6"
          id="resume-content"
          style={{
        ...
        >
          <div
            className="w-full col-span-4 flex flex-col items-center justify-start p-1 sm:p-2 md:p-4"
            style={{
          ...
          >
            ...
            <div className="w-full flex flex-col items-start justify-start mt-2 sm:mt-4 gap-2 sm:gap-4 md:gap-6 text-white">
              <Section title="EDUCATION">
                <AnimatePresence>
                  {localResume?.Education?.map((edu, index) => (
                    <motion.div key={index} className="w-full mt-2 relative">
                      <input
                        type="text"
                        readOnly={!isEdit}
                        name="degree"
                      ...
                      <textarea
                        readOnly={!isEdit}
                        className={`text-xs text-gray-200 mt-1 w-full h-auto outline-none resize-none border-none ${
                  ...
                  {localResume?.Projects?.map((project, index) => (
                    ...
                    >
                      <input
                        ...
                        className={`w-full bg-transparent outline-none border-none text-sm font-semibold uppercase text-gray-100 ${
                      ...
                      <textarea
                        readOnly={!isEdit}
                        className={`text-xs text-gray-200 mt-1 w-full outline-none border-none ${
                          isEdit ? "bg-[#1c1c1c]" : "bg-transparent"
                        }`}
                        name="description"
                  ...
                  {localResume?.Contact?.map((contact, index) => (
                    ...
                    >
                      <input
                        ...
                        className={`bg-transparent outline-none text-sm font-semibold uppercase text-gray-100 ${
                          isEdit && "text-yellow-400 w-full"
                        }`}
                      />
                      <input
          ...
          <div className="col-span-8 flex flex-col items-center justify-start py-2 sm:py-4 md:py-6">
            <div
              className="w-full px-1 sm:px-2 md:px-6 py-2 sm:py-4"
            ...
            >
              <input
                ...
                className={`bg-transparent outline-none border-none text-2xl font-sans uppercase tracking-wider text-txtDark font-extrabold ${
              ...
              <input
                ...
                type="text"
                readOnly={!isEdit}
                className={`bg-transparent outline-none border-none text-lg tracking-widest uppercase text-txtPrimary w-full ${
                  isEdit && "text-white"
                }`}
              />
            </div>

            <div className="w-full pl-1 sm:pl-2 md:px-6 py-2 sm:py-4 flex flex-col items-start justify-start gap-2 sm:gap-4 md:gap-6">
              <Section title="ABOUT ME">
                <textarea
                  readOnly={!isEdit}
                  className={`text-sm text-txtPrimary tracking-wider w-full outline-none border-none ${
              ...
              <Section title="WORK EXPERIENCE">
                <AnimatePresence>
                  {localResume?.Experience?.map((exp, index) => (
                    <motion.div
                      key={index}
                      className="w-full grid grid-cols-12 gap-2 mb-4"
                    >
                      <div className="col-span-4">
                        <input
                          ...
                          type="text"
                          readOnly={!isEdit}
                          className={`outline-none border-none text-sm tracking-wide uppercase text-txtDark w-full ${
                            isEdit ? "bg-gray-200" : "bg-transparent"
                          }`}
                        />
                      </div>
                      <div className="col-span-8 relative">
                        {isEdit && (
                          ...
                          >
                            <FaTrash className="text-sm text-txtPrimary" />
                          </motion.div>
                        )}
                        <input
                          value={exp.position}
                          ...
                          type="text"
                          readOnly={!isEdit}
                          className={`outline-none border-none font-sans text-base tracking-wide capitalize text-txtDark w-full ${
                            isEdit ? "bg-gray-200" : "bg-transparent"
                          }`}
                        />
                        <input
                        ...
                        <textarea
                          readOnly={!isEdit}
                          className={`text-xs mt-2 text-txtPrimary tracking-wider w-full outline-none border-none ${
                            isEdit ? "bg-gray-200" : "bg-transparent"
                          }`}
                          name="description"
              ...
              <Section title="SKILLS">
                <div className="w-full flex flex-wrap items-center justify-start gap-4">
                  {localResume?.Skills?.flatMap((skillGroup, skillGroupIndex) =>
                    skillGroup.skills.map((skill, skillIndex) => (
                      <div
                        key={`${skillGroupIndex}-${skillIndex}`}
                        className="flex-1"
                        ...
                        <div className="w-full flex items-center justify-between">
                          <div className="flex items-center justify-center">
                            <input
                              ...
                              type="text"
                              readOnly={!isEdit}
                              className={`outline-none border-none text-sm tracking-wide capitalize font-semibold text-txtPrimary w-full mr-4 ${
                                isEdit ? "bg-gray-200" : "bg-transparent"
                              }`}
                            />
                            {isEdit && (
                              <input
                                ...
                                name="level"
                                type="text"
                                className={`outline-none border-none text-sm tracking-wide capitalize font-semibold text-txtPrimary w-16 ${
                                  isEdit ? "bg-gray-200" : "bg-transparent"
                                }`}
                              />
                            )}
...
const Section = ({ title, children }) => {
  return (
    <div className="w-full mb-2 sm:mb-4 md:mb-6">
      <p className="uppercase text-sm sm:text-base md:text-xl tracking-wider font-semibold mb-1 sm:mb-2 border-b border-yellow-300 pb-1">
        {title}
      </p>
      {children}
    </div>
